        ...
        <div class="header">
            <nav class="navbar fixed-top navbar-expand-lg shadow-sm">
                ...
                <form class="form-inline form-custom">
                    <button class="btn btn-custom" type="button"><a href="signup.php" style="text-decoration: none; color: #1cb0f6; font-weight: bold;">Sign Up</a></button>
                </form>
            </nav>
        </div>
        <div class="container-fluid container-custom">
            <h3 class="display-7">Log In</h3><br>
            ...
            <div class="input-group input-group-md mb-3">
                <input type="button" class="form-control btn-create" value="LOG IN">
            </div>
